...
class OrderItem extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($orderItem) {
            if (is_null($orderItem->InsertAt)) {
                $orderItem->InsertAt = now();
            }
            if (is_null($orderItem->InsertUserId) && auth()->check()) {
                $orderItem->InsertUserId = auth()->id();
            }
        ...
        static::updating(function ($orderItem) {
            $orderItem->UpdateBy = now();
            if (auth()->check()) {
                $orderItem->UpdateUserId = auth()->id();
            }
